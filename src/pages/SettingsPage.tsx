              ...
              <table>
                ...
                <tbody>
                  {[
                    ...
                    ['Phiếu Hợp tác (Coop Slip)', <Check size={16} color="var(--color-success)" />, <Check size={16} color="var(--color-success)" />, <X size={16} color="var(--color-text-muted)" />, <X size={16} color="var(--color-text-muted)" />, <X size={16} color="var(--color-text-muted)" />, <X size={16} color="var(--color-text-muted)" />],
