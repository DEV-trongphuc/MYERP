...
import { 
  ...
  Clock3, Scale, Trash2, RefreshCw, Check, X 
} from 'lucide-react';
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '0.25rem' }}>
                <div className="form-group">
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '6px' }}>
                    ...
                    {user && (
                      (Number((user as any).is_confirmed) === 1 || (user as any).email?.endsWith('@ideas.edu.vn')) ? (
            ...
            {(() => {
              ...
              return (
                <form onSubmit={handleChangePassword} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  ...
                  <div className="form-group">
                    <label className="form-label" style={{ fontWeight: 600, fontSize: '0.8rem' }}>{t('Mật khẩu hiện tại')} <span style={{ color: '#ef4444' }}>*</span></label>
                    <div style={{ position: 'relative' }}>
                      <input
                  ...
                  <div className="form-group">
                    <label className="form-label" style={{ fontWeight: 600, fontSize: '0.8rem' }}>{t('Mật khẩu mới')} <span style={{ color: '#ef4444' }}>*</span></label>
                    <div style={{ position: 'relative' }}>
                      <input
                  ...
                  <div className="form-group">
                    <label className="form-label" style={{ fontWeight: 600, fontSize: '0.8rem' }}>{t('Xác nhận mật khẩu mới')} <span style={{ color: '#ef4444' }}>*</span></label>
                    <input
                      type={showNewPass ? 'text' : 'password'}
                      className="form-input"
                  ...
                  <button
                    type="submit"
                    className="btn primary"
                    disabled={changingPass || !passData.oldPassword || !isStrong || !isConfirmMatch}
                    style={{ alignSelf: 'flex-end', height: '36px', padding: '0 16px', background: '#10b981', fontWeight: 600, fontSize: '0.8rem', borderRadius: '8px' }}
                  >
