...
export const WarRoomFlightDeck: React.FC<WarRoomProps> = ({
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      if (currentTheme === 'light') {
        ...
        localStorage.setItem('Ideas_theme', 'dark');
  ...
  const triggerSimulatedLead = (log: any) => {
    ...
    const newFeedItem = {
      id: particleId,
      lead_name: name,
      assigned_to_name: status === 'rejected' ? 'IDEAS AI' : salesList[saleIdx]?.name || 'Hệ thống',
      status: 'processing',
          ...
          {!isFocusMode && (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
                ...
                <div>
                  <h2 style={{ fontSize: '1.22rem', fontWeight: 800, letterSpacing: '0.08em', color: '#fff', textShadow: '0 0 12px rgba(163, 20, 34,0.6)' }}>IDEAS AI INFINITY</h2>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: isMobile ? '0.5rem' : '0.6rem', fontWeight: 900, letterSpacing: '0.12em', marginTop: '6px', opacity: 0.95, color: '#ffffff', textShadow: '0 1px 3px rgba(0,0,0,0.5)', zIndex: 1 }}>IDEAS AI</div>
                </div>
              </div>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: isMobile ? 3 : 6 }}>
                <div style={{ fontSize: isMobile ? '0.55rem' : '0.68rem', color: '#e63946', textTransform: 'uppercase', letterSpacing: '0.12em', display: 'flex', alignItems: 'center', gap: 6, fontWeight: 800 }}>
                  <Terminal size={isMobile ? 10 : 12} /> Live Feed: IDEAS AI VIRTUAL DISPATCH CONSOLE
                </div>
