    ...
    <AnimatePresence>
      <div 
        style={{
          position: 'fixed',
          inset: 0,
          zIndex: 99999999, // Topmost level, above header, sidebar, and all floats
          display: 'flex',
          alignItems: 'center',
      ...
      >
        {/* Pitch-black Dark Overlay with Backdrop Blur */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          ...
          style={{
            position: 'fixed',
            inset: 0,
            background: 'rgba(0, 0, 0, 0.78)', // Dark black overlay covering whole screen
        ...
        >
          ...
          <div style={{
            ...
            {/* Top row: Status Tag & Close button */}
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <button
                ...
                onMouseEnter={e => { e.currentTarget.style.backgroundColor = 'var(--color-bg-light)'; e.currentTarget.style.color = 'var(--color-text)'; }}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap', paddingTop: '2px' }}>
              ...
              {task.due_date && (
                <span style={{
                  ...
                  <span>{t('Hạn chót')}: <strong style={{ color: 'var(--color-text)' }}>{task.due_date.slice(0, 10)}</strong></span>
                </span>
              )}
              ...
              {task.task_group_name && (
                <span style={{
                  ...
                  background: 'var(--color-bg-light)',
                  border: '1px solid var(--color-border)',
                  color: task.task_group_color || 'var(--color-text)',
                  display: 'inline-flex',
                  alignItems: 'center',
                  gap: '4px'
                }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '5px', fontSize: '0.65rem', fontWeight: 700, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: '0.4px' }}>
                  <User size={12} style={{ color: '#3b82f6' }} />
                  <span>{t('Người tạo')}</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', minWidth: 0 }}>
                  <Avatar src={creatorAvatar} name={creatorName} size={30} />
                  <span style={{ fontSize: '0.8rem', fontWeight: 650, color: 'var(--color-text)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                    {creatorName}
                  </span>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', minWidth: 0 }}>
                  <div style={{ position: 'relative', display: 'flex' }}>
                    ...
                    <span style={{ position: 'absolute', bottom: -1, right: -1, width: 8, height: 8, borderRadius: '50%', background: '#10b981', border: '1.5px solid var(--color-surface)' }} />
                  </div>
                  <span style={{ fontSize: '0.8rem', fontWeight: 650, color: 'var(--color-text)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                    {assigneeName}
                  </span>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              <label style={{ fontSize: '0.7rem', fontWeight: 700, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: '0.5px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                <FileText size={13} />
              ...
              <div style={{
                ...
                {displayDescription ? (
                  ...
                  <span style={{ fontSize: '0.78rem', fontStyle: 'italic', color: 'var(--color-text-muted)' }}>
                    {t('Không có mô tả chi tiết kèm theo.')}
                  </span>
                ) : null}

                {/* Detected Links Cards (e.g. Google Sheets, docs, links) */}
                    ...
                    {detectedUrls.map((url, idx) => {
                      ...
                      return (
                        <a
                          ...
                          onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--color-primary)'; e.currentTarget.style.boxShadow = '0 2px 8px rgba(0,0,0,0.05)'; }}
                ...
                {checklistItems.length > 0 && (
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '0.7rem', fontWeight: 700, color: 'var(--color-text-muted)' }}>
                      <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                        <CheckSquare size={12} />
                        <span>{t('Danh sách việc con (Checklist)')}</span>
                      </span>
                      <span style={{ color: doneChecklist === totalChecklist ? '#10b981' : 'var(--color-text)' }}>
                    ...
                    {checklistItems.map((c: any, cIdx: number) => {
                      ...
                      return (
                        <div key={c.id || cIdx} style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.75rem', color: isDone ? 'var(--color-text-muted)' : 'var(--color-text)' }}>
                          <span style={{
                            width: 14,
                            height: 14,
                            borderRadius: '4px',
            ...
            <label style={{
              ...
              gap: '12px',
              padding: '12px 16px',
              background: isAgreed ? 'rgba(16, 185, 129, 0.08)' : 'var(--color-bg-light)',
              border: isAgreed ? '1.5px solid rgba(16, 185, 129, 0.4)' : '1px solid var(--color-border)',
              borderRadius: '14px',
              cursor: 'pointer',
              userSelect: 'none',
              ...
              />
              <span style={{ fontSize: '0.8125rem', fontWeight: 650, color: 'var(--color-text)', lineHeight: 1.4 }}>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '11px',
                border: 'none',
                background: isAgreed ? 'linear-gradient(135deg, #10b981 0%, #059669 100%)' : 'var(--color-border)',
                color: '#ffffff',
                fontWeight: 700,
                fontSize: '0.8125rem',
