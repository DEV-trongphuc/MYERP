        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              {/* Open in external new tab button */}
              <a
                href={current.url}
                target="_blank"
          ...
          {/* Center Main Content (Gentle Framer Motion Animation) */}
          <AnimatePresence mode="wait">
            ...
            >
              {isPdf(current) ? (
                ...
                /* Non-image, non-pdf generic document card */
                <div
                  style={{
          ...
          {/* Bottom Dot / Pill Indicator for Multiple Attachments */}
          {items.length > 1 && (
            <div
              style={{
                position: 'fixed',
              ...
              {items.map((item, idx) => (
                <button
                  ...
                  style={{
                    ...
                    height: '8px',
                    borderRadius: '999px',
                    background: idx === validIndex ? 'var(--color-primary, #e11d48)' : 'rgba(255, 255, 255, 0.38)',
                    border: 'none',
                    cursor: 'pointer',
                    padding: 0,
