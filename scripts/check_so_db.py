...
print("=== DESC sales_orders ===")
print(query("DESCRIBE sales_orders;"))

print("=== COUNT & SAMPLE sales_orders ===")
print(query("SELECT count(*) FROM sales_orders;"))
print(query("SELECT * FROM sales_orders LIMIT 3;"))
