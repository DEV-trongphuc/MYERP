...
print("=== TABLES IN DB ===")
print(query("SHOW TABLES LIKE '%order%';"))
print(query("SHOW TABLES LIKE '%sale%';"))
print(query("SHOW TABLES LIKE '%contract%';"))
print(query("SHOW TABLES LIKE '%deal%';"))
print(query("SHOW TABLES LIKE '%misa%';"))
